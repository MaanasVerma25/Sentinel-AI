  ...
  component: () => (
    <div className="space-y-6 max-w-3xl">
      <div>
        ...
        <p className="mt-1 text-sm text-muted-foreground">Detection thresholds and team alerting.</p>
      </div>
      <section className="rounded-lg border border-border bg-card p-5 space-y-4">
        <h2 className="text-sm font-semibold uppercase tracking-wider text-muted-foreground">Detection thresholds</h2>
      ...
      <section className="rounded-lg border border-border bg-card p-5 space-y-4">
        <h2 className="text-sm font-semibold uppercase tracking-wider text-muted-foreground">Alerting</h2>
  ...
  return (
    <label className="block">
      ...
      <div className="flex items-center gap-2 rounded-md border border-border bg-background px-3 py-2">
        <input defaultValue={defaultValue} className="flex-1 bg-transparent text-sm focus:outline-none" />
