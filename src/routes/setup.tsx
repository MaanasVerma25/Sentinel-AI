        ...
        <div className="grid gap-12 lg:grid-cols-5">
          ...
          <div className="lg:col-span-3">
            <div className="mb-8 tech-line pb-4 relative">
              ...
              <p className="mt-4 text-xs leading-relaxed text-[#6C7584]">
                Play with the interactive steps below to see how Sentinel detects anomalies in real time.
              </p>
            </div>
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="flex flex-col border border-[#343940] bg-[#131518] p-6 relative group transition-all duration-300 hover:border-[#298DFF]/40">
                ...
                <p className="text-xs leading-relaxed text-[#6C7584] mb-6">
                  Sentinel learns your normal traffic patterns (3–7 days) and sets smart thresholds per crisis category.
                </p>
              ...
              <div className="flex flex-col border border-[#343940] bg-[#131518] p-6 relative group transition-all duration-300 hover:border-[#298DFF]/40">
                ...
                <p className="text-xs leading-relaxed text-[#6C7584] mb-6">
                  The moment a real anomaly hits, your team gets a Slack/email alert + an AI-generated incident report.
                </p>
          ...
          <div className="lg:col-span-2">
            <div className="sticky top-32 flex flex-col border border-[#343940] bg-[#131518] p-8 shadow-2xl">
              ...
              <h2 className="mb-2 text-2xl font-bold uppercase tracking-wider text-white">Create Account</h2>
              ...
              <form onSubmit={handleRegister} className="flex flex-col gap-5">
                <div className="flex flex-col gap-2">
                  <label className="text-[10px] font-mono uppercase tracking-widest text-[#6C7584]">Full Name</label>
                  <input 
                    type="text" 
                    required
                    value={fullName}
                ...
                <div className="flex flex-col gap-2">
                  <label className="text-[10px] font-mono uppercase tracking-widest text-[#6C7584]">Work Email</label>
                  <input 
                    type="email" 
                    required
                    value={email}
